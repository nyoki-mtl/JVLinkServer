...
| 10 | 本年・累計成績情報 | performance_stats | tuple[[BRPerformanceStatsItem](#brperformancestatsitem), ...] | 2回繰り返し |  | 本年・累計の成績情報 |

### BRPerformanceStatsItem

| サブ項番 | フィールド名 | Python変数名 | 説明 | 型 | 桁数・文字数 | 初期値 |
|----------|-------------|-------------|------|-----|------------|-------|
...
| 10d | 着回数 | placing_counts | 1着～5着,着外の回数 | [PlacingCounts](#placingcounts) | 数値6桁×6 | 数字ゼロ |
