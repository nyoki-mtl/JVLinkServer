...
| --- | ------ | --------- | --- | ----------- | --- | --- |
| 1 | レコード種別ID | record_type | str | 半角2文字 |  | 固定値"TC" |
| 2 | データ区分 | data_code | TCDataCategory | 数値1桁 | 数字ゼロ | 1:初期値 |
...
| 11 | 変更後発走時刻 | after_post_time | TimeHHMM | 数値4桁 | 数字ゼロ | 時分各2桁 hhmm形式 |
| 12 | 変更前発走時刻 | before_post_time | TimeHHMM | 数値4桁 | 数字ゼロ | 時分各2桁 hhmm形式 |
