...
| 11 | `mining_predictions` | array:object[18] | 32 | 270 | マイニング予想 |  |
|  | `  .horse_number` | int | +0 | 2 | 馬番 |  |
|  | `  .predicted_finish_time` | duration_mss_ss | +2 | 5 | 予想走破タイム |  |
|  | `  .error_margin_plus` | duration_ss_ss | +7 | 4 | 予想誤差+ |  |
|  | `  .error_margin_minus` | duration_ss_ss | +11 | 4 | 予想誤差- |  |
