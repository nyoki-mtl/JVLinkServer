...
| 4 | `trainer_code` | str | 12 | 5 | 調教師コード | KEY |
| 5 | `deregistration_flag` | str | 17 | 1 | 調教師抹消区分 |  |
| 6 | `license_issue_date` | date_yyyymmdd | 18 | 8 | 調教師免許交付年月日 |  |
| 7 | `license_revoked_date` | date_yyyymmdd | 26 | 8 | 調教師免許抹消年月日 |  |
| 8 | `birth_date` | date_yyyymmdd | 34 | 8 | 生年月日 |  |
| 9 | `trainer_name` | str | 42 | 34 | 調教師名 |  |
| 10 | `trainer_name_kana` | str | 76 | 30 | 調教師名半角カナ |  |
| 11 | `trainer_name_short` | str | 106 | 8 | 調教師名略称 |  |
| 12 | `trainer_name_english` | str | 114 | 80 | 調教師名欧字 |  |
| 13 | `sex_code` | str | 194 | 1 | 性別区分 |  |
| 14 | `affiliation_code` | str | 195 | 1 | 調教師東西所属コード |  |
| 15 | `invitation_area_name` | str | 196 | 20 | 招待地域名 |  |
| 16 | `recent_graded_wins` | array:object[3] | 216 | 489 | 最近重賞勝利情報 |  |
...
| 17 | `performance_stats` | array:object[3] | 705 | 3156 | 本年前年累計成績情報 |  |
|  | `  .year` | int | +0 | 4 | 設定年 |  |
