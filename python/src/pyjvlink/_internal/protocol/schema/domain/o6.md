...
| 13 | `trifecta_sales_flag` | flag | 40 | 1 | 発売フラグ 3連単 |  |
| 14 | `trifecta_odds` | array:object[4896] | 41 | 83232 | 3連単オッズ |  |
|  | `  .combination` | str | +0 | 6 | 組番 |  |
|  | `  .odds` | float | +6 | 7 | オッズ |  |
|  | `  .popularity_rank` | int | +13 | 4 | 人気順 |  |
| 15 | `trifecta_total_votes` | money_100yen | 83273 | 11 | 3連単票数合計 |  |
