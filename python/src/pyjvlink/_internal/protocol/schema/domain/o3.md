...
| 13 | `wide_sales_flag` | flag | 40 | 1 | 発売フラグ ワイド |  |
| 14 | `wide_odds` | array:object[153] | 41 | 2601 | ワイドオッズ |  |
|  | `  .combination` | str | +0 | 4 | 組番 |  |
|  | `  .min_odds` | float | +4 | 5 | 最低オッズ |  |
|  | `  .max_odds` | float | +9 | 5 | 最高オッズ |  |
|  | `  .popularity_rank` | int | +14 | 3 | 人気順 |  |
| 15 | `wide_total_votes` | money_100yen | 2642 | 11 | ワイド票数合計 |  |
